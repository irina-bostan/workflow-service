...
final class DuffelApiDtos {
    ...
    record FlightOffer(String id, String totalAmount, String totalCurrency, Airline owner, List<FlightSliceResponse> slices) {}
    ...
    // ---- Stays: request ----
    record StaysSearchBody(String checkInDate, String checkOutDate, int rooms, List<StayGuest> guests, StayLocation location) {}
